...
<h1 class="page-title"> TreeGrid
    <small>>>新增节点</small>
</h1>

<div class="row">
    <div class="col-md-8">
        <form role="form" id="treegridForm" name="treegridForm" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group input-xlarge">
                            <input id="parentId" type="hidden" name="parentId" value="${TreeGrid.parentId}">
                            <input id="parentName" type="text" name="parentName" readonly="readonly" class="form-control" placeholder="" value="${TreeGrid.parentName}">
